...
<br>
<br>
Before you start, remember to make a new project file - call it something like "week_3".  Save the project folder somewhere sensible (maybe create a new folder called something like
